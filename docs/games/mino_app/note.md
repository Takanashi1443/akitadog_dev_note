...
Gradleというのは、Androidアプリを作る際、よく分からないけど古いバージョンとかでうまく動かないのを防いだりしてくれるらしいシステム。
...
参考ページ：[[Unity] アプリをビルドしてandroid実機上でテストする](https://uni.gas.mixh.jp/unity/android-build.html)
